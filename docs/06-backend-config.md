...
| `p_points_common` | 10 | Common 開箱獲得 P 點（Chest Odyssey 活動開啟時） | ✅ 已確認 |
| `p_points_rare` | 20 | Rare 開箱獲得 P 點（Chest Odyssey 活動開啟時） | ✅ 已確認 |
| `p_points_epic` | TBD | Epic 開箱獲得 P 點（Chest Odyssey 活動開啟時） | 🔴 待確認 |
| `p_points_legendary` | TBD | Legendary 開箱獲得 P 點（Chest Odyssey 活動開啟時） | 🔴 待確認 |
...
## 6.4 Chest Odyssey 通行證參數（Chest Odyssey 活動開啟時）
...
| `odyssey_event_duration` | TBD | 單次活動持續時間 | 🔴 待確認 |
| `odyssey_schedule_enabled` | false | 通行證活動是否開啟（運營排程控制） | ✅ 已確認 |
| `odyssey_start_time` | TBD | 活動排程開始時間（UTC） | 🔴 由運營設定 |
| `odyssey_end_time` | TBD | 活動排程結束時間（UTC） | 🔴 由運營設定 |
